...
const dinnerMenu: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Sea Scallops", price: "68", desc: "Five Sea Scallops pan seared to perfection and basted with white wine, fresh thyme, and garlic butter" },
      ...
      { name: "Classic Shrimp Scampi", price: "58", desc: "Fine colossal shrimp topped with fresh lump crab in a traditional scampi butter" },
      { name: "Fried or Grilled Shrimp", price: "56", desc: "Colossal shrimp hand-breaded, seasoned and fried until golden" },
      { name: "Lobster Tail Dinner", price: "96", desc: "8–10 oz of beautifully prepared Maine Lobster with drawn butter" },
      { name: "Colossal Shrimp and Sea Scallops with Cheesy Grits", price: "60", desc: "Drizzled with house-made hot sauce" },
    ],
  },
  {
